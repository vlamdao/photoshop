...
function getFileToSave(layer) {
    var saveFile = File(document.path + "\\" + getDocumentNameWithoutExtension() + " - " + layer.name + ".png");
    return saveFile;
}

function getDocumentNameWithoutExtension() {
    var documentName = document.name;
    var lastDot = documentName.lastIndexOf('.');
    var fileName = documentName.substring(0, lastDot);
    return fileName
}
